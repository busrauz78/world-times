...
export default function TopStoryCard({
  ...
  return (
    <div className="max-w-sm p-6 bg-white border border-gray-200 rounded shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <p className="mb-3 text-xs text-gray-700 dark:text-gray-400">{byline}</p>
